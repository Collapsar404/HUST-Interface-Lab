...
proc create_root_design { parentCell } {
  ...
  set lcd_miso [ create_bd_port -dir I lcd_miso ]
  set lcd_mosi [ create_bd_port -dir O lcd_mosi ]
  set lcd_sck [ create_bd_port -dir O lcd_sck ]
  set lcd_ss [ create_bd_port -dir O lcd_ss ]
  ...
  connect_bd_net -net i_accel_miso_0_1 [get_bd_ports lcd_miso] [get_bd_pins wb_spi_wrapper_0/i_accel_miso]
  ...
  connect_bd_net -net wb_spi_wrapper_0_o_accel_cs_n [get_bd_ports lcd_ss] [get_bd_pins wb_spi_wrapper_0/o_accel_cs_n]
  connect_bd_net -net wb_spi_wrapper_0_o_accel_mosi [get_bd_ports lcd_mosi] [get_bd_pins wb_spi_wrapper_0/o_accel_mosi]
  connect_bd_net -net wb_spi_wrapper_0_o_accel_sclk [get_bd_ports lcd_sck] [get_bd_pins wb_spi_wrapper_0/o_accel_sclk]
