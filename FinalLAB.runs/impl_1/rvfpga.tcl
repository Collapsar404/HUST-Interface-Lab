...
set rc [catch {
  ...
  add_files -quiet F:/RVfpgaLab/RVfpgaSoc_1/FinalLAB/FinalLAB.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source F:/RVfpgaLab/RVfpgaSoc_1/RVfpga_SoC-lab1/lab_src/script.tcl"
    source F:/RVfpgaLab/RVfpgaSoc_1/RVfpga_SoC-lab1/lab_src/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script F:/RVfpgaLab/RVfpgaSoc_1/RVfpga_SoC-lab1/lab_src/script.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
